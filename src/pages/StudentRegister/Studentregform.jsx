...
export default function Studentregform() {
    const schema = z.object({
        ...
        StartupDescription: z.string().min(1, { message: "Description cannot be empty" }),
        StartupFounder: z.string().min(1, { message: "Founder's Name cannot be empty" }),
        StartupTeam: z.string(),
        StartupEmail: z.string().email({ message: "Invalid email format" }),
        StartupContactNumber: z.string().min(1, { message: "Contact Number cannot be empty" }),
        StartupStage: z.string().min(1, { message: "Startup Stage cannot be empty" }),
        StartupPitchDeck: z.string(),
        PastAchievements: z.string(),
        CreatePassword: z.string().min(8, { message: "Password must be at least 8 characters long" }),
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="col-12 mb-2">
          ...
          {errors.StartupDescription && (
            <p className="text-danger mt-2">* {errors.StartupDescription.message}</p>
          )}
        </div>
        ...
        <div className="col-12 mb-2">
          ...
          {errors.StartupFounder && (
            <p className="text-danger mt-2">* {errors.StartupFounder.message}</p>
          )}
        </div>
        ...
        <div className="col-12 mb-2">
          ...
          {errors.StartupPitchDeck && (
            <p className="text-danger mt-2">* {errors.StartupPitchDeck.message}</p>
          )}
        </div>
        ...
        <div className="col-12 mb-2">
          ...
          {errors.PastAchievements && (
            <p className="text-danger mt-2">* {errors.PastAchievements.message}</p>
          )}
        </div>
