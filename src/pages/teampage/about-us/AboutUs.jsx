        ...
        <div className="aboutUs">
            ...
            <div className="aboutUsContents">
                ...
                <div className="aboutUsTextbox">
                    The Student Incubation Cell, IIT Delhi is formed with an intent to promote design thinking, planful ideation and to support budding Entrepreneurs at IIT DELHI who can make a mark on the world map through their vision, next-generation technology, and services, by leading from the front. Our mission is to empower every student in the campus in every way possible who aim high to translate their ideas into real-world Startups and to help them in a smooth transition in every phase of this journey. As they say, “It’s not about ideas, it’s about making ideas happen" and we are committed to pave the way with every step one takes.
                </div>
            </div>
        </div>
    )
