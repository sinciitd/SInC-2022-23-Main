    ...
    <div className="footer">
      <div className="foot-text footer-left">
        <a href="https://home.iitd.ac.in/">
          IIT Delhi , Hauz Khas
          <br />© 2023 Copyright: SInC IIT-Delhi
        </a>
      </div>
      <div className="foot-text footer-center">
        <img
          src={Logo}
          alt="SInC Logo"
          style={{
      ...
      <div className="foot-text footer-right">
        ...
        <a href="https://www.linkedin.com/company/sinciitd">
          <svg
            className="footer-icon "
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
